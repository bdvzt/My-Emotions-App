...
//    private let duringDayView: DuringDayView
    ...
    init(data: WeekStatistic) {
        self.categoryView = CategoryView(
            viewModel: CategoryStatisticsViewModel(categoryData: data.categoryData)
        )

        self.dayStatisticView = DayStatisticView(
            viewModel: DayStatisticsViewModel(dayData: data.dayData)
        )

//        self.mostFrequentlyView = MostFrequentlyView(
//            viewModel: FrequencyStatisticsViewModel(data: data.frequencyData)
//        )
//
//        self.duringDayView = DuringDayView(
//            viewModel: PartOfDayStatisticsViewModel(data: data.partsOfDayData)
//        )
